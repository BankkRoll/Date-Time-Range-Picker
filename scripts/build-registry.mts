...
import { z } from "zod";
import { registryItemSchema, type Registry } from "../registry/registry-types";

// Import your registry items
import { examples } from "../registry/registry-examples";
import { ui } from "../registry/registry-ui";

const registry = {
  name: "Date Time Range Picker",
  homepage: "https://date-time-range-picker.vercel.app",
...
async function main() {
  try {
    ...
    console.error("❌ Error building registry:");
